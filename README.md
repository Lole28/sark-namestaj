...
Izrađeno u **PHP-u (8.x) i MySQL-u** uz sopstvenu MVC arhitekturu. Dizajn je u
editorijalnom stilu (krem podloga, scroll-reveal animacije, rotirajuća traka radova,
lightbox), prilagođen bojama logoa (antracit + taupe).
