-- ============================================================
--  Šark nameštaj po meri — verzija za InfinityFree / deljeni hosting
--
--  NE pravi bazu i NE bira je (nema CREATE DATABASE / USE),
--  jer se na InfinityFree baza kreira u kontrolnoj tabli.
--
--  Uvoz u phpMyAdmin:
--    1) levo IZABERI svoju bazu (npr. epiz_31234567_sark)
--    2) kartica "Uvoz (Import)"  ->  izaberi ovaj fajl  ->  "Kreni (Go)"
-- ============================================================
