                    ...
                    <div class="row g-3">
                        <div class="col-sm-7 mb-3">
                            ...
                            <input name="materijal" class="form-control" value="<?= $v('materijal') ?>"
                                   placeholder="npr. iverica 18 mm, dekor hrast, ABS kant">
                        </div>
